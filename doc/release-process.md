...
space *do not upload these to the broccolicoin.net server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the broccolicoin.net Github repo
...
- Update broccolicoin.net version - Langerhans to do

- Announce the release:

  - Release sticky on BroccoliCoin Forums: http://forum.broccolicoin.net/forum/news-community/community-announcements
