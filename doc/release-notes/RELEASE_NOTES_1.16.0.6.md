BroccoliCoin Core version 1.16.0.6 is now available from:

  <https://github.com/broccolicoin/broccolicoin/releases/tag/v1.16.0.6/>
...
and remove versions equal to or older than v1.16.0.4 off the network.
...
BroccoliCoin Core introduces pruning the blockchain in 1.14. Pruning
...
When BroccoliCoin Core is out-of-sync on startup, a semi-transparent information
...
Since 1.14.0 the approximate transaction fee shown in BroccoliCoin-Qt when using coin
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of BroccoliCoin Core. This was added in conjunction with
