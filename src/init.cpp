...
void Shutdown()
{
    ...
    RenameThread("broccolicoin-shutoff");
    ...
    StopHTTPServer();
#ifdef ENABLE_WALLET
    // BroccoliCoin 1.14 TODO: ShutdownRPCMining();
    if (pwalletMain)
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("broccolicoin-loadblk");
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("BroccoliCoin version %s\n", FormatFullVersion());
}
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // BroccoliCoin: Do we need to do any RPC mining init here?
