...
public:
    CMainParams() {
        ...
        // BIP34 is never enforced in BroccoliCoin v2 blocks, so we enforce from v3
        ...
        // XXX: BIP heights and hashes all need to be updated to BroccoliCoin values
        ...
        //TODO: fix this for broccolicoin -- plddr
        ...
        checkpointData = (CCheckpointData) {
            ...
            (       1, uint256S("0x594a42d8fe16382085dc982135df72cf8fcea12d34e6efd566e2f9e442e2136f")) // First block mined within the BroccoliCoin Blockchain 03/04/2021
