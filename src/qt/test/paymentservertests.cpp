...
void PaymentServerTests::paymentServerTests()
{
    ...
    // BroccoliCoin: Disable certificate tests as we don't touch this code, and building test
    ...
    /* PL: This doesn't work for BroccoliCoin (as there is no actual maximum coins)
